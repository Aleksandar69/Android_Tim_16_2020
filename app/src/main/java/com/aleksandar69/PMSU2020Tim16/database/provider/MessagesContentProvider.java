...
public class MessagesContentProvider extends ContentProvider {
        ...
        switch (uriType) {
            ...
            case MESSAGE_ID:
                ...
                if (TextUtils.isEmpty(selection)) {
                    rowsDeleted = sqlDB.delete(MessagesDBHandler.TABLE_MESSAGES, MessagesDBHandler.COLUMN_ID + "=" + id, null);
                } else {
                    rowsDeleted = sqlDB.delete(MessagesDBHandler.TABLE_MESSAGES, MessagesDBHandler.COLUMN_ID + "=" + id + " and " + selection,
                            selectionArgs);
                }
                break;
            default:
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriType) {
            case MESSAGE_ID:
                queryBuilder.appendWhere(MessagesDBHandler.COLUMN_ID + "="
            ...
            case MESSAGE_ID:
                ...
                if (TextUtils.isEmpty(selection)) {
                    rowsUpdated =
                            sqlDB.update(MessagesDBHandler.TABLE_MESSAGES,
                                    values,
                                    MessagesDBHandler.COLUMN_ID + "=" + id,
                                    null);
                } else {
                    rowsUpdated =
